 ...
 * 
 */
@WebServiceClient(name = "SubtractionService", targetNamespace = "http://service.fiap3esr.com.br/", wsdlLocation = "http://localhost:8080/calculadora/subtraction?wsdl")
    ...
    extends Service
{
    ...
    private static final QName SUBTRACTIONSERVICE_QNAME = new QName("http://service.fiap3esr.com.br/", "SubtractionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/calculadora/subtraction?wsdl");
    ...
    public Operation getSubtractionPort() {
        return super.getPort(new QName("http://service.fiap3esr.com.br/", "SubtractionPort"), Operation.class);
    }
    ...
    public Operation getSubtractionPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.fiap3esr.com.br/", "SubtractionPort"), Operation.class, features);
    }
